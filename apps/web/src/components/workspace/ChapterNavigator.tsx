...
export function ChapterNavigator({
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl border border-slate-200/70 shadow-[0_1px_3px_rgba(15,23,42,0.04),0_1px_2px_rgba(15,23,42,0.03)] sticky top-0 z-10 px-4 py-3 mb-2">
      ...
      <div className="bg-white rounded-2xl border border-slate-200/70 shadow-[0_1px_3px_rgba(15,23,42,0.04),0_1px_2px_rgba(15,23,42,0.03)] py-2">
      {loading ? (
